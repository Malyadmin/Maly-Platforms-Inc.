...
const translations: Record<string, Record<TranslationKey, string>> = {
  en: {
    ...
    bestRooftops: 'Rooftops',
    bestDateSpots: 'Date Spots',
    bestDayTrips: 'Day Trips',
