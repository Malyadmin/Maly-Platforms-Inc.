...
const translations: Record<string, Record<TranslationKey, string>> = {
  en: {
    ...
    checkIn: {
      ...
      selectEvent: "Select an event to start checking in attendees",
      noUpcomingEvents: "No upcoming events to check in",
      noPastEvents: "No past events",
      total: "total",
      checkedInLabel: "checked in",
      attended: "attended",
      scanningFor: "Scanning tickets for",
      ...
      scanNewTicket: "Scan New Ticket",
      confirmTitle: "Confirm Check-In",
      confirmMessage: "Check in {name} to this event?",
      confirm: "Confirm",
      success: "Check-In Successful",
      checkedIn: "has been checked in",
      error: "Check-In Failed",
      attendeeList: "Attendee List",
      noAttendees: "No attendees for this event",
      attendedEvent: "attended this event",
  ...
  es: {
    ...
    checkIn: {
      ...
      selectEvent: "Selecciona un evento para comenzar el check-in",
      noUpcomingEvents: "No hay eventos próximos para check-in",
      noPastEvents: "No hay eventos pasados",
      total: "total",
      checkedInLabel: "registrados",
      attended: "asistieron",
      scanningFor: "Escaneando entradas para",
      startScanning: "Iniciar Escaneo",
      stopScanning: "Detener Escaneo",
      invalidTicket: "Entrada Inválida",
      cameraError: "Error de Cámara",
      cameraPermission: "Por favor permite acceso a la cámara para escanear códigos QR",
      event: "Evento",
      tickets: "Entradas",
      status: "Estado",
      alreadyCheckedIn: "Ya Registrado",
      readyToCheckIn: "Listo para Registrar",
      confirmCheckIn: "Registrar",
      scanAnother: "Escanear Otro",
      scanNewTicket: "Escanear Nueva Entrada",
      confirmTitle: "Confirmar Check-In",
      confirmMessage: "¿Registrar a {name} en este evento?",
      confirm: "Confirmar",
      success: "Check-In Exitoso",
      checkedIn: "ha sido registrado",
      error: "Error en Check-In",
      attendeeList: "Lista de Asistentes",
      noAttendees: "No hay asistentes para este evento",
      attendedEvent: "asistieron a este evento",
