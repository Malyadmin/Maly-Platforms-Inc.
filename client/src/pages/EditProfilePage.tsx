...
const moodStyles = {
  ...
  "Day Parties": "bg-yellow-500/20 text-yellow-500 hover:bg-yellow-500/30 border-yellow-500/30",
  "Afterhours": "bg-purple-500/20 text-purple-500 hover:bg-purple-500/30 border-purple-500/30",
  ...
  "Culture & Travel": "bg-rose-500/20 text-rose-500 hover:bg-rose-500/30 border-rose-500/30",
