    ...
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-8">
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-white">2. Use of Service</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-white">3. User Content</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-white">4. Event Creation and Attendance</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-white">5. Payments and Refunds</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-white">6. Prohibited Conduct</h2>
            <p className="text-gray-300 leading-relaxed mb-3">
              You may not:
            </p>
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-white">8. Limitation of Liability</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-white">9. Changes to Terms</h2>
            <p className="text-gray-300 leading-relaxed">
