    ...
    <div className="min-h-screen bg-background dark:bg-black text-foreground flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-8">
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-foreground">What We Do</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-foreground">Our Community</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-foreground">Get In Touch</h2>
            <p className="text-muted-foreground leading-relaxed">
